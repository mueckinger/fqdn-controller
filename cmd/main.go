...
func main() {
	...
	// TODO: migrate to the events.k8s.io API (mgr.GetEventRecorder), which exposes a different recorder interface.
	eventRecorder := mgr.GetEventRecorderFor("fqdn-controller") //nolint:staticcheck // SA1019: legacy events API
